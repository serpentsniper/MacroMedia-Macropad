...
bug is a 9 key media macropad with a rotary encoder and an OLED display. It uses KMK firmware on CircuitPython and is built around the Seeed XIAO RP2040.
